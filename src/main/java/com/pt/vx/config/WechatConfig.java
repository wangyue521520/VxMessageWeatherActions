...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wx2d2580ff0bf33310";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "ca6a9ffbfdeec21a65f2d8df450025b4";
    ...
    static {
        userList.add(getUser(
                "olgHh6s3my53IIevt7qjUvB", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "jysZJya0UUne2dKF068odTqaWC2nVhmjo9BJuzegYNk", //要给这个人发送的模板ID
                "王越", //咋称呼这个人
                "河北省保定市莲池区", //这个人的详细地址
                "保定市", //这个人在的城市
                new BirthDay(2003,9,3,true,false,"pt生日快乐！！"),
                new BirthDay(2002,4,29,false,false,"生日快乐哦~~"),
                new BirthDay(2024,7,14,true,true),
                new BirthDay(2022,7,14,true,false,"周年快乐！！！")
        ));
